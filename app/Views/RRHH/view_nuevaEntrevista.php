...
<main> 
    ...
    <div class="">
    <form method="POST" action="<?=site_url('AdminRH/crearEntrevista/'.$datosPersonalRRHH['IDPERSONALRECURSOSHUMANOS'].'/'.$datosSolicitante['IDSOLICITANTE']);?>" class="" id="crearEntrevista" name="crearEntrevista">
