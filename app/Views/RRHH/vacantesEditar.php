...
<?php print_r($requerimientosvacanteEditar); ?>-->
    ...
    <div class="card border-right">
        <div class="card-body">
            ...
            <form action="<?= site_url('AdminRH/actualizarVacantes') ?>" method="post" enctype="multipart/form-data">

                <input type="hidden" name="id2" value="<?= $vacanteEditar['IDVACANTE'] ?>">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                       ...
                       <!-- <input type="text" value="<?= $vacanteEditar['DESCRIPCIONVACANTE'] ?>" name="descripcionVC" id="descripcionVC" class="form-control" placeholder="" aria-describedby="helpId" required>-->
                        <textarea  cols="40" rows="5" type="text"  name="descripcionVC" id="descripcionVC" class="form-control" placeholder="" aria-describedby="helpId" required><?= $vacanteEditar['DESCRIPCIONVACANTE'] ?></textarea>
                        <!-- <small id="helpId" class="text-muted">Aqui debe colocar su nombre</small>-->
                    </div>
                    <div class="mb-3">
                       ...
                       <!-- <input type="text" value="<?= $vacanteEditar['REQUERIMIENTOSPROPIOSVACANTE'] ?>" name="requerimientosVC" id="requerimientosVC" class="form-control" placeholder="" aria-describedby="helpId" required>-->
                        <textarea  cols="40" rows="5" type="text"  name="requerimientosVC" id="requerimientosVC" class="form-control" placeholder="" aria-describedby="helpId" required><?= $vacanteEditar['REQUERIMIENTOSPROPIOSVACANTE'] ?></textarea>
                    </div>
                    <div class="row mb-3">
