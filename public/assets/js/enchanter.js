class Enchanter {
    ...
    next() {
        ...
        let nextElement = this.container.querySelector('.navbar-nav .nav-link:nth-child(' + this.tabNextIndex + ')');
    ...
    previous() {
        ...
        let nextElement = this.container.querySelector('.navbar-nav .nav-link:nth-child(' + this.tabPreviousIndex + ')');
        new bootstrap.Tab(nextElement).show();
    ...
    currentIndex() {
        return this.getIndex(this.container.querySelector('.navbar-nav .nav-link.active'));
    }
    nextIndex() {
        let nextIndexCandidate = this.tabCurrentIndex + 1;
        if (this.container.querySelector('.navbar-nav .nav-link:nth-child(' + nextIndexCandidate + ')') == null) {
            return null;
        }
